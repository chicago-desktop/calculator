...
tests for public behaviour (the arithmetic and the key grid in
`test/src/engine_test.lua`, the entry in `test/src/window_test.lua`), and attach or describe the shot in
